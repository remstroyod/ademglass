...
function adem_styles() {
    wp_enqueue_style( 'style-adem', get_template_directory_uri() . '/assets/css/style.css', array(), '1.0.7' );
    wp_enqueue_style( 'customize-adem', get_template_directory_uri() . '/assets/css/customize.css', array(), '1.0.7' );
}
/**
 * JS files
 */
